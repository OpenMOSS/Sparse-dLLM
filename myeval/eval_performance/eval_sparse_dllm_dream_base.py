...
from opencompass.models import Sparse_dLLM_DreamCausalLM
...
models = [
    ('dream_v0_7b_base-sparse_dllm', {}, {'steps': 256, }, 3, 0.5), 
]

models = [
    dict(
        type=Sparse_dLLM_DreamCausalLM, abbr=abbr, path=path_dict[abbr.split('-')[0]],
